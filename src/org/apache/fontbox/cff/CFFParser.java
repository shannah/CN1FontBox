...
public class CFFParser
{
    ...
    private CFFFont parseFont(int index) throws IOException
    {
        ...
        font.addValueToTopDict("ItalicAngle", getNumber(topDict, "ItalicAngle", new Integer(0)));
        font.addValueToTopDict("UnderlinePosition", getNumber(topDict, "UnderlinePosition", new Integer(-100)));
        font.addValueToTopDict("UnderlineThickness", getNumber(topDict, "UnderlineThickness", new Integer(50)));
        font.addValueToTopDict("PaintType", getNumber(topDict, "PaintType", new Integer(0)));
        font.addValueToTopDict("CharstringType", getNumber(topDict, "CharstringType", new Integer(2)));
        ...
        font.addValueToTopDict(
                ...
                getArray(
                        ...
                        Arrays.<Number> asList(Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0),
                                Integer.valueOf(0))));
        font.addValueToTopDict("StrokeWidth", getNumber(topDict, "StrokeWidth", new Integer(0)));
        ...
        if (rosEntry != null)
        {
            ...
            for (int i = 0; i < fdIndex.getCount(); ++i)
            {
                ...
                fontDictMap.put("FontType", getNumber(fontDictData, "FontType", new Integer(0)));
                ...
                int localSubrOffset = getNumber(privateDict, "Subrs", Integer.valueOf(0)).intValue();
