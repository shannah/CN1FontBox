...
public class Type2CharString extends Type1CharString
{
    ...
    private void handleCommand(List<Integer> numbers, CharStringCommand command)
    {
        ...
        {
            List<Integer> first = Arrays.asList(numbers.get(0), new Integer(0),
                    numbers.get(1), numbers.get(2), numbers.get(3), new Integer(0));
            List<Integer> second = Arrays.asList(
                    numbers.get(4), new Integer(0),
                    numbers.get(5), new Integer(-numbers.get(2).intValue()),
                    numbers.get(6), new Integer(0));
        ...
        else if ("hflex1".equals(name))
        {
            List<Integer> first = Arrays.asList(numbers.get(0), numbers.get(1), 
                    numbers.get(2), numbers.get(3), numbers.get(4), new Integer(0));
            List<Integer> second = Arrays.asList(numbers.get(5),new Integer(0),
                    numbers.get(6), numbers.get(7), numbers.get(8), new Integer(0));
            addCommandList(Arrays.asList(first, second), new CharStringCommand(8));
        }
    ...
    private List<Integer> clearStack(List<Integer> numbers, boolean flag)
    {
        if (type1Sequence.size() == 0)
        {
            if (flag)
            {
                addCommand(Arrays.asList(new Integer(0), new Integer(numbers.get(0).intValue() + nominalWidthX)),
            ...
            {
                addCommand(Arrays.asList(new Integer(0), new Integer(defWidthX)),
                    new CharStringCommand(13));
            }
        }
        return numbers;
    ...
    private void drawAlternatingCurve(List<Integer> numbers, boolean horizontal)
    {
        while (numbers.size() > 0)
        {
            ...
            if (horizontal)
            {
                addCommand(Arrays.asList(numbers.get(0), new Integer(0),
            ...
            {
                addCommand(Arrays.asList(new Integer(0), numbers.get(0),
        ...
        while (numbers.size() > 0)
        {
            ...
            if (horizontal)
            {
                addCommand(Arrays.asList(numbers.get(first ? 1 : 0),
                        ...
                        new Integer(0)), new CharStringCommand(8));
            } 
            else
            {
                addCommand(Arrays.asList(first ? numbers.get(0) : Integer
                        ...
                        new Integer(0), numbers.get(first ? 4 : 3)),
                        new CharStringCommand(8));
            }
